...
const AppHead: React.FC<Props> = ({
  ...
  let author = "Woulf";
  let description =
    "Articles sur la programmation, le développement, les technologies, l'ingénierie logicielle, mes projets personnels et mes expériences.";
  let siteName = "Woulf's Blog";
  let type = "article";
  ...
  let appOgImage = `${process.env.NEXT_PUBLIC_URL}/woulf-blog-og.png`;
  let appOgImageAlt = "Woulf's Blog";
